#!/usr/bin/env python3
"""Build every MT Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write mt-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "mt-permit-kit")
ZIP_PATH = os.path.join(HERE, "mt-permit-kit.zip")
ZIP_ROOT = "mt-permit-kit"
