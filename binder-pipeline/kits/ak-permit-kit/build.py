#!/usr/bin/env python3
"""Build every AK Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write ak-permit-kit.zip
"""
...
ZIP_PATH = os.path.join(HERE, "ak-permit-kit.zip")
ZIP_ROOT = "ak-permit-kit"
