...
# document that grows from 9 to 10 pages starts writing tn1-01.png while the
# old tn1-1.png survives — and you end up reviewing a stale page. Wipe first.
set -e
cd "$(dirname "$0")"
rm -rf png && mkdir -p png
for f in out/tn-permit-kit/*.pdf; do
