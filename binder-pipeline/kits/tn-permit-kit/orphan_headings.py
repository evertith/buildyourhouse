#!/usr/bin/env python3
"""Stranded-heading detector for the TENNESSEE Permit Kit PDFs.
...
Usage:
  python3 orphan_headings.py            # audit out/tn-permit-kit/*.pdf
...
def is_heading(text):
    ...
    "SFMO" or a table cell reading "NEC 2017" would, so a heading has to carry
