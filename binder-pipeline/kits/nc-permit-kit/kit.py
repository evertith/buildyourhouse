"""Shared furniture and helpers for the North Carolina Owner-Builder Permit Kit.
...
SECTION = "North Carolina Owner-Builder Permit Kit"
HEADER_LEFT = "NORTH CAROLINA OWNER-BUILDER PERMIT KIT"
...
def disclaimer(extra=None):
    ...
    txt = ("This is a process reference, not legal advice. North Carolina "
           "permits are administered by 100 counties and dozens of "
           "municipalities, and local requirements vary. Confirm every item "
           "with the inspections department that will issue your permit "
...
def sources_table(rows, title=None):
    ...
    return d.titled_table(
        title or f"Sources — every North Carolina claim in this document "
                 f"({VERIFIED})",
        hdr, body_rows, [CW - 2.15 * inch, 2.15 * inch], S, write_rows=False)


STATUTE_NOTE = (
    "Read any General Statute cited above at <b>ncleg.gov</b> → Enacted "
    "Legislation → Statutes → by Section, or directly at ncleg.gov/"
    "EnactedLegislation/Statutes/HTML/BySection/Chapter_87/GS_87-1.html with "
    "the chapter and section swapped in. All statute text verified "
    "August 2026.")
