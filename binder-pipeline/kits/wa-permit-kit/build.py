#!/usr/bin/env python3
"""Build every WASHINGTON Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write wa-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "wa-permit-kit")
ZIP_PATH = os.path.join(HERE, "wa-permit-kit.zip")
ZIP_ROOT = "wa-permit-kit"
