#!/usr/bin/env python3
"""Build every FLORIDA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write fl-permit-kit.zip
"""
...
ZIP_PATH = os.path.join(HERE, "fl-permit-kit.zip")
ZIP_ROOT = "fl-permit-kit"
