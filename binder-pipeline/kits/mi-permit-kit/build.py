#!/usr/bin/env python3
"""Build every MI Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write mi-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "mi-permit-kit")
ZIP_PATH = os.path.join(HERE, "mi-permit-kit.zip")
ZIP_ROOT = "mi-permit-kit"
