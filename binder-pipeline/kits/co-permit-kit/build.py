#!/usr/bin/env python3
"""Build every CO Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write co-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "co-permit-kit")
ZIP_PATH = os.path.join(HERE, "co-permit-kit.zip")
ZIP_ROOT = "co-permit-kit"
