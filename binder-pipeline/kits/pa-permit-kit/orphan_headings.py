#!/usr/bin/env python3
"""Stranded-heading detector for the PENNSYLVANIA Permit Kit PDFs.
...
Usage:
  python3 orphan_headings.py            # audit out/pa-permit-kit/*.pdf
...
def is_heading(text):
    ...
    "SEO" or a table cell reading "IRC 2021" would, so a heading has to carry
