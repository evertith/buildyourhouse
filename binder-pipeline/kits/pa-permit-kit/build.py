#!/usr/bin/env python3
"""Build every PENNSYLVANIA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write pa-permit-kit.zip
"""
...
ZIP_PATH = os.path.join(HERE, "pa-permit-kit.zip")
ZIP_ROOT = "pa-permit-kit"
