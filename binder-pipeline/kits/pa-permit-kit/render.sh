...
# document that grows from 9 to 10 pages starts writing pa1-01.png while the
# old pa1-1.png survives — and you end up reviewing a stale page. Wipe first.
set -e
cd "$(dirname "$0")"
rm -rf png && mkdir -p png
for f in out/pa-permit-kit/*.pdf; do
