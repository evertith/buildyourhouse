#!/usr/bin/env python3
"""Build every MS Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write ms-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "ms-permit-kit")
ZIP_PATH = os.path.join(HERE, "ms-permit-kit.zip")
ZIP_ROOT = "ms-permit-kit"
