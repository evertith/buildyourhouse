#!/usr/bin/env python3
"""Output audit for the MISSISSIPPI Permit Kit PDFs.

Catches the three defects that survive a clean build but ruin a printed page:
...
def audit(pdf):
    ...
    for i, ws in enumerate(pages, start=1):
        ...
        is_cover = name.startswith("MS.0") and i == 1
