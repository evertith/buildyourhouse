#!/usr/bin/env python3
"""Build every GEORGIA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write ga-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "ga-permit-kit")
ZIP_PATH = os.path.join(HERE, "ga-permit-kit.zip")
ZIP_ROOT = "ga-permit-kit"
