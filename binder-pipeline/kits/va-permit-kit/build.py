#!/usr/bin/env python3
"""Build every VIRGINIA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write va-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "va-permit-kit")
ZIP_PATH = os.path.join(HERE, "va-permit-kit.zip")
ZIP_ROOT = "va-permit-kit"
