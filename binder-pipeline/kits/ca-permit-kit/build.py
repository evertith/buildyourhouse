#!/usr/bin/env python3
"""Build every CALIFORNIA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write ca-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "ca-permit-kit")
ZIP_PATH = os.path.join(HERE, "ca-permit-kit.zip")
ZIP_ROOT = "ca-permit-kit"
