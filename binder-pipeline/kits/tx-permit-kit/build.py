#!/usr/bin/env python3
"""Build every TEXAS Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write tx-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "tx-permit-kit")
ZIP_PATH = os.path.join(HERE, "tx-permit-kit.zip")
ZIP_ROOT = "tx-permit-kit"
