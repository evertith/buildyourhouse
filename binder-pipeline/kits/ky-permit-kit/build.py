#!/usr/bin/env python3
"""Build every KENTUCKY Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write ky-permit-kit.zip
"""
...
OUT = os.path.join(HERE, "out", "ky-permit-kit")
ZIP_PATH = os.path.join(HERE, "ky-permit-kit.zip")
ZIP_ROOT = "ky-permit-kit"
