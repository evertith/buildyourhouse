#!/usr/bin/env python3
"""Build every LOUISIANA Permit Kit document, audit the output, and zip the folder.

Usage:
  python3 build.py          # regenerate all PDFs and audit them
  python3 build.py --zip    # also write la-permit-kit.zip
"""
...
ZIP_PATH = os.path.join(HERE, "la-permit-kit.zip")
ZIP_ROOT = "la-permit-kit"
