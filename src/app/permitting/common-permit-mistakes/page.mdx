...
<table className="dataTable">
  ...
  <tbody>
    <tr>
      <td>Starting without permit</td>
      <td className="numeric">$500-$5,000 fines + demolition</td>
      <td>3-6 months</td>
    </tr>
    <tr>
      <td>Wrong code version</td>
      <td className="numeric">$3,000-$8,000</td>
      <td>6-12 weeks</td>
    </tr>
    <tr>
      <td>Incomplete plans</td>
      <td className="numeric">$1,000-$3,000 per revision</td>
      <td>2-6 weeks each</td>
    </tr>
    <tr>
      <td>Wrong setbacks (after pour)</td>
      <td className="numeric">$20,000-$50,000</td>
      <td>3-6 months</td>
    </tr>
    <tr>
      <td>No energy calculations</td>
      <td className="numeric">$200-$500</td>
      <td>1-3 weeks</td>
    </tr>
    <tr>
      <td>Missing engineer stamps</td>
      <td className="numeric">$500-$2,500 + premium</td>
      <td>2-4 weeks</td>
    </tr>
    <tr>
      <td>Covering work before inspection</td>
      <td className="numeric">$2,000-$10,000</td>
      <td>2-4 weeks</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Impact fees surprise</td>
      <td className="numeric">$10,000-$40,000</td>
      <td>Immediate</td>
    </tr>
    <tr>
      <td>Not getting septic first</td>
      <td className="numeric">$3,000-$15,000</td>
      <td>2-6 months</td>
    </tr>
    <tr className="totalRow">
      <td><strong>TOTAL POTENTIAL COST</strong></td>
      <td className="numeric"><strong>$50,000-$150,000+</strong></td>
