...
**Why it's terrible**:
- Illegal in nearly all incorporated and code-adopting jurisdictions—but a minority of rural counties have no permit requirement (parts of MO, CO, west TX, AZ, and a few states with no statewide residential code). Verify locally before assuming you're exempt.
- Subject to immediate stop-work orders
- Fines of $500-$5,000+ per violation
- Usually requires a retroactive (legalization) permit: you submit as-built plans, get the work inspected, correct anything that fails, and pay fees plus fines (often a double or "investigation" fee). Full demolition is the last resort—reserved for work that can't be made code-compliant.
...
**Why it fails**:
- Energy compliance is required in most states (a few—AZ, KS, MO—have no mandatory statewide residential energy code, so confirm yours)
- REScheck or equivalent is mandatory where an energy code applies
- Plans won't be approved without it
- Takes 30 minutes to complete

**Real cost**: 1-3 week delay while you create and submit energy calculations

**Solution**: Run REScheck (free software) or hire someone ($200-$500). Most states accept REScheck, but a few require their own tools—California (Title 24/CBECC), Oregon, and Virginia among them—so confirm which method your state uses. Include it with your initial application. This is easy—don't skip it.
...
**Requirements vary sharply by state—don't assume these apply to you**:
...
**Typical permit validity**: Under the IRC default (R105.5), a permit becomes invalid if work doesn't commence within 180 days (6 months) or is abandoned for 180 days. Some jurisdictions extend this to a year or longer—confirm your local period.
