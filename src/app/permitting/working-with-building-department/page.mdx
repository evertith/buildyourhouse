export const metadata = {
  title: 'Working With Building Inspectors — Tips From a Retired GC',
  description: 'How to build a good relationship with your building department. Communication tips, scheduling advice, and what inspectors actually want from you.',
};
...
<CalloutBox type="info" title="Their Job in One Line">
The department's mandate is code compliance and public safety—not designing, fixing, or managing your project. Knowing where their role ends keeps your expectations realistic.
</CalloutBox>

<DataTable
  caption="What the Building Department Is — and Is Not"
  headers={["Primary Responsibilities", "What They Are NOT"]}
  rows={[
    ["Review plans for code compliance", "Your project designer"],
    ["Issue building permits", "Your problem solver"],
    ["Conduct inspections throughout construction", "Your contractor"],
    ["Enforce building codes consistently", "Your teacher (though many help anyway)"],
...
<DataTable
  caption="Building Department Roles and Responsibilities"
...
<CalloutBox type="tip" title="The Pre-App Meeting Sets the Tone">
Your pre-application meeting shapes how the department treats you for the entire project. Show up prepared and respectful, and you bank goodwill you'll draw on for months.
</CalloutBox>

<DataTable
  caption="Pre-Application Meeting: Do and Don't"
  headers={["DO This", "DON'T Do This"]}
  rows={[
    ["Show up on time (or early)", "Show up unprepared or disorganized"],
    ["Bring organized documents", "Argue about code requirements"],
    ["Take detailed notes", "Act like you know more than them"],
    ["Ask thoughtful questions", "Complain about regulations"],
    ["Thank them for their time", "Waste their time with questions you could Google"],
    ["Follow their advice", ""]
  ]}
/>
...
<CalloutBox type="tip" title="Four Habits That Earn Trust">
Be professional, responsive, honest, and prepared. Inspectors notice owner-builders who communicate well, and they extend more flexibility to the ones they trust.
</CalloutBox>
...
<DataTable
  caption="How to Ask Code Questions Effectively"
...
<CalloutBox type="tip" title="Best Window: Tuesday–Thursday Mornings">
Book 24–48 hours ahead and aim for mid-week mornings, when inspectors are freshest and least rushed. Leave buffer time so a re-inspection doesn't stall the next trade.
</CalloutBox>
...
<DataTable
  caption="Inspection Behavior: What NOT to Do vs. What TO Do"
  headers={["DON'T Do This", "DO This Instead"]}
  rows={[
...
<DataTable
  caption="Plan Amendments: Minor vs. Major Changes"
  headers={["Minor Changes (often allowed on-site)", "Major Changes (require formal process)"]}
  rows={[
    ["Inspector approval during inspection", "Require permit amendment application"],
    ["Document changes on your plans", "Additional fees ($100-$500 typically)"],
    ["May need formal amendment for final records", "New plan review process"],
...
<CalloutBox type="critical" title="File Before the Expiration Date">
Request an extension before your permit lapses. Let it expire and you may have to reapply, pay full fees again, and meet new code requirements—a far more expensive path than a timely extension.
</CalloutBox>
...
Ask before you build, build relationships early, make yourself the inspector's easiest stop of the day, document everything, learn from every inspection, respect their authority, and route each question to the right person.
</CalloutBox>
...
<DataTable
  caption="Bad vs. Good Approach Comparison"
  headers={["Bad Approach", "Good Approach"]}
  rows={[
