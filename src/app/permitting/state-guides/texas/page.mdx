...
Texas pushes the actual separation distances down to the county or the authorized agent, so draw the lot before you assume any of them — the free [Site Plan Studio](/site-plan-studio) measures each one on a to-scale sheet and prints who sets it.
