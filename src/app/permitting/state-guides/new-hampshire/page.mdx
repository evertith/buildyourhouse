export const metadata = {
  alternates: { canonical: '/permitting/state-guides/new-hampshire' },
...
<ArticleSchema path="/permitting/state-guides/new-hampshire" headline={"New Hampshire Owner-Builder Permits 2026: Costs, Codes & Towns"} description={"New Hampshire owner-builder permit guide 2026: statewide State Building Code (2021 IRC), local-only enforcement, no-permit towns, homeowner electrical and plumbing exemptions, deep snow loads, frost depth and some of the nations highest radon. Plain-English breakdown."} />
...
<CodeAlertCapture state="New Hampshire" />
...
That site/plot plan is one you can draw yourself: the free [Site Plan Studio](/site-plan-studio) sets it to a standard engineering scale, dimensions the setbacks and the well-to-septic distance, and prints it on letter paper with a title block.
