...
- **2023 Oregon Residential Specialty Code (ORSC)** — based on the 2021 International Residential Code with Oregon amendments. Effective Oct. 1, 2023; mandatory statewide April 1, 2024. (The 2026 ORSC, based on the 2024 IRC, is in the adoption process with an anticipated effective date of Oct. 1, 2026 — confirm before submitting late-2026 plans.)
- **2023 Oregon Electrical Specialty Code (OESC)** — based on the 2023 National Electrical Code (NEC). Effective Oct. 1, 2023.
- **2023 Oregon Plumbing Specialty Code (OPSC)** — based on the 2021 Uniform Plumbing Code. Effective Oct. 1, 2023.
- **Residential energy efficiency** for one- and two-family dwellings is set within the ORSC (energy chapter). The separate **2025 Oregon Energy Efficiency Specialty Code (OEESC)**, based on ASHRAE 90.1-2022 (effective Jan. 1, 2025; mandatory July 1, 2025), governs commercial and larger buildings — for a single-family home, follow the ORSC energy provisions.
