...
<ArticleSchema path="/permitting/state-guides/oregon" headline={"Oregon Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Oregon owner-builder permit guide 2026: state code adoption, CCB exemption, county permit costs, seismic and wildfire requirements. Plain-English breakdown."} />
...
Site them before you site the house — the free [Site Plan Studio](/site-plan-studio) places the well, the drainfield and its replacement area to scale and measures the separations for the DEQ or county application.
