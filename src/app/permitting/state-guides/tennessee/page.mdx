export const metadata = {
  title: 'Tennessee Owner-Builder Permit Guide 2025 | TN Building Permit Requirements',
  description: 'Complete guide to Tennessee owner-builder permits. TN building codes, permit costs, timelines, and owner-builder laws for building your own home in Tennessee.',
