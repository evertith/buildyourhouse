export const metadata = {
  ...
  openGraph: {
    title: 'North Dakota Owner-Builder Permits 2026: Costs, Codes & Counties',
    description: 'North Dakota owner-builder permit guide 2026: locally-adopted state building code (2024 IRC, effective Jan 1, 2026), the $4,000 contractor-license threshold, state electrical and plumbing homeowner self-wire rules, very deep frost, and the nation-leading radon problem.',
  },
}

<ArticleSchema path="/permitting/state-guides/north-dakota" headline={"North Dakota Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"North Dakota owner-builder permit guide 2026: locally-adopted state building code (2024 IRC, effective Jan 1, 2026), the $4,000 contractor-license threshold, state electrical and plumbing homeowner self-wire rules, very deep frost, and the nation-leading radon problem. Plain-English breakdown for Fargo, Bismarck, Grand Forks, and Minot."} />
...
<CodeAlertCapture state="North Dakota" />
...
<DataTable
  caption="North Dakota energy requirements by climate zone (IECC, 2024 edition)"
...
Draw it before the evaluator arrives — the free [Site Plan Studio](/site-plan-studio) puts the well, the drainfield and the house on one to-scale sheet and dimensions every separation the district health unit is going to check.
