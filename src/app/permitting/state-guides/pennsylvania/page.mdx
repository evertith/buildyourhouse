...
<CalloutBox type="info" title="2021 IECC statewide as of January 1, 2026">
...
<DataTable
  caption="2021 IECC / 2021 IRC envelope requirements by PA climate zone"
...
<DataTable
  caption="Frost depth by PA region"
...
<DataTable
  caption="Standard PA inspection schedule in enforcement areas (typically 10–13 inspections)"
  headers={["#", "Inspection"]}
  rows={[
    ["1", "Footing"],
...
<DataTable
  caption="Ground snow load by PA region/elevation"
  headers={["Region / elevation", "Ground snow load"]}
  rows={[
    ["Southern PA", "25 psf"],
...
<CalloutBox type="tip" title="Check the snow load map for your township">
...
Sand mounds take real room, so check the layout on paper first: the free [Site Plan Studio](/site-plan-studio) draws the parcel to scale, dimensions well-to-system, and prints a letter-size sheet for the SEO.
