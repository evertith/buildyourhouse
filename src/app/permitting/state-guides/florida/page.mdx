export const metadata = {
  title: 'Florida Owner-Builder Permit Guide 2025 | FL Building Permit Requirements & Hurricane Codes',
  description: 'Complete guide to Florida owner-builder permits. FL building codes, hurricane requirements, permit costs, timelines, and county-specific regulations for building your own home in Florida.',
  ...
  openGraph: {
    title: 'Florida Owner-Builder Permit Guide 2025',
    description: 'Everything you need to know about getting owner-builder permits in Florida, including hurricane codes, costs, and county requirements.',
  },
}
