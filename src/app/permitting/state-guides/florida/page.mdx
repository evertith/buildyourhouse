...
Because the water table drives so much of the layout here, it pays to draw the lot first: the free [Site Plan Studio](/site-plan-studio) places the well, tank and drainfield to scale, measures the distance between them, and prints a letter-size sheet for the health-department application.
