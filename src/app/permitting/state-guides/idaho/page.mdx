export const metadata = {
  alternates: { canonical: '/permitting/state-guides/idaho' },
...
<ArticleSchema path="/permitting/state-guides/idaho" headline={"Idaho Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Idaho owner-builder permit guide 2026: statewide Idaho Residential Code, DOPL electrical/plumbing/HVAC permits, county fees, homeowner DIY rules, snow loads and energy requirements. Plain-English breakdown."} />
...
It is worth drawing the lot before that evaluation. The free [Site Plan Studio](/site-plan-studio) will place the well, tank and drainfield to scale and tell you the distance between each one, which is the first thing a health-district reviewer goes looking for.
