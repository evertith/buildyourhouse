export const metadata = {
  alternates: { canonical: '/permitting/state-guides/arizona' },
...
<ArticleSchema path="/permitting/state-guides/arizona" headline={"Arizona Owner-Builder Permits 2026: Desert Codes & Costs"} description={"Arizona owner-builder permit guide 2026: desert construction, county codes, permit costs, and exemption rules. Step-by-step guide for AZ builders."} />
...
<CodeAlertCapture state="Arizona" />
...
A to-scale plot plan is the cheapest way to find out whether the well, the drainfield and its reserve area all fit before you pay for a design — the free [Site Plan Studio](/site-plan-studio) draws one, dimensions every separation on the sheet, and prints it letter size.
