export const metadata = {
  title: 'Georgia Owner-Builder Permit Guide 2025 | GA Building Permit Requirements & Costs',
  description: 'Complete guide to Georgia owner-builder permits. GA building codes, permit costs, timelines, and county requirements for building your own home in Georgia.',
