export const metadata = {
  alternates: { canonical: '/permitting/state-guides/georgia' },
...
<ArticleSchema path="/permitting/state-guides/georgia" headline={"Georgia Owner-Builder Permits 2026: Costs, Codes & Laws"} description={"Georgia owner-builder permit guide 2026: 2024 IRC codes, the O.C.G.A. owner exemption, DIY electrical/plumbing/HVAC rules, permit costs, and county process. Can you build your own home in GA? Yes."} />
...
<ProductCTA
  ...
  kicker="Georgia · Permit Kit"
  title="Want this as a working checklist?"
  lead="The Georgia Permit Kit is these rules as printable checklists with the citations on the page — the § 43-41-17 exemption walkthrough (including the 24-month one-sale rule), the permit application checklist, the inspection sequence, and where to file each piece. 32 pages, verified against O.C.G.A., DCA, DPH, EPD, and GDOT sources."
  price={34}
  sku="ga-permit-kit"
  context="ga-state-guide"
  cta="See the kit"
/>


<CodeAlertCapture state="Georgia" />
...
<CalloutBox type="tip" title="Financing an owner-builder build in Georgia">

Once the permit math is settled, the bigger question is funding. Georgia owner-builders have real options — specialist owner-builder lenders operate in the state, and farm-credit co-ops finance construction on rural land. The [owner-builder financing guide](/financing) covers who lends, what they require, and how to present your project, or [get a lender shortlist](/financing#lender-match) for your situation.
...
Many Georgia properties use septic. The **county health department** regulates the process, and installation by a licensed installer is required. The regulation itself sets a clock: the county board of health "shall approve or disapprove such application within twenty days after the receipt of a completed application" (DPH Rule 511-3-1-.03(2)(a)) — though assembling a complete application, the site evaluation, and installation scheduling commonly stretch the full path to several weeks.

A complete application starts with a drawing, and the free [Site Plan Studio](/site-plan-studio) will lay the house, well and absorption field out to scale, dimension the separations, and print on the sheet that Georgia leaves those distances to the county health department.
