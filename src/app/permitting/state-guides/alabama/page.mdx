...
<CodeAlertCapture state="Alabama" />
...
Draw the parcel before you call: the free [Site Plan Studio](/site-plan-studio) lays the well, tank and drainfield out to scale, dimensions the distance between them, and prints on the sheet who sets that minimum in Alabama.
