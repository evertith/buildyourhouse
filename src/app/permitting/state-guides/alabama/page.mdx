...
[Act 2024-443](https://hblb.alabama.gov/law/) transferred authority to adopt the residential building code from ADECA to the [Home Builders Licensure Board](https://hblb.alabama.gov/) effective October 1, 2024, and created a Residential Building Code Advisory Council charged with presenting an updated code for adoption by October 1, 2025. The statute ([Ala. Code § 34-14A-12](https://hblb.alabama.gov/faq/%C2%A7-34-14a-11-promulgation-of-rules-and-regulations/)) provides that beginning **January 1, 2027** a residential builder must construct in accordance with the applicable adopted residential code or the local jurisdiction's code. Because the edition is being updated, **confirm with your building department which IRC/IECC edition is actually in force at your permit date** rather than assuming the long-standing 2015 base.
