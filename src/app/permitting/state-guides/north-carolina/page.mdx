export const metadata = {
  title: 'North Carolina Owner-Builder Permit Guide 2025 | Complete NC Building Permit Requirements',
  description: 'Complete guide to getting owner-builder permits in North Carolina. NC building codes, permit costs, timelines, licensing requirements, and county-specific regulations for building your own home.',
  keywords: 'North Carolina owner builder permit, NC building permit, North Carolina residential building code, NC owner builder laws, building permit costs North Carolina',
  openGraph: {
    title: 'North Carolina Owner-Builder Permit Guide 2025',
    description: 'Everything you need to know about getting owner-builder permits in North Carolina, including costs, timelines, and requirements.',
  },
}
