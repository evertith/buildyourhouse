export const metadata = {
  title: "North Carolina Owner-Builder Guide (2026) — Permits, Codes & Requirements",
  description: "Complete NC owner-builder guide with county-specific requirements for Wake, Mecklenburg, Guilford & more. Permits, codes, insurance, and costs. Start planning your NC build.",
