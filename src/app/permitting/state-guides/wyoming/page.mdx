export const metadata = {
  alternates: { canonical: '/permitting/state-guides/wyoming' },
...
<ArticleSchema path="/permitting/state-guides/wyoming" headline={"Wyoming Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Wyoming owner-builder permit guide 2026: no statewide building code, mostly unregulated rural counties, state electrical homeowner rule, extreme wind and snow loads. Plain-English breakdown."} />
...
<CodeAlertCapture state="Wyoming" />
...
Even where nobody inspects the house, the septic and zoning counters still want a drawing — the free [Site Plan Studio](/site-plan-studio) makes one at no cost: lot, house, well and system to scale, with the separations dimensioned and the office that sets them named on the sheet.
