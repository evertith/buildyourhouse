...
<ArticleSchema path="/permitting/state-guides/virginia" headline={"Virginia Owner-Builder Permits 2026: Costs, Codes & Process"} description={"Virginia owner-builder permit guide 2026: statewide USBC code, the \u00a754.1-1101 owner exemption, permit costs, and why you still need licensed trades. Plain-English guide."} />
...
<ProductCTA
  ...
  kicker="Virginia · Permit Kit"
  title="Want this as a working checklist?"
  lead="The Virginia Permit Kit is these rules as printable checklists with the citations on the page — the § 54.1-1101 exemption walkthrough, the permit application checklist with the lien-agent line that protects you, the USBC inspection sequence, and where to file each piece. 31 pages, verified against law.lis.virginia.gov, DHCD, VDH, DEQ, and VDOT sources."
  price={34}
  sku="va-permit-kit"
  context="va-state-guide"
  cta="See the kit"
/>


<CodeAlertCapture state="Virginia" />
...
<CalloutBox type="tip" title="Financing an owner-builder build in Virginia">

Permits are cheap next to the build itself. Virginia owner-builders typically fund through community banks, credit unions, and the handful of specialists that lend to self-builders here. The [owner-builder financing guide](/financing) maps the landscape and the approval process, or [get a lender shortlist](/financing#lender-match) for your project.
...
Those distances are worth measuring on a drawing rather than eyeballing: the free [Site Plan Studio](/site-plan-studio) puts the well, the tank and the drainfield to scale, dimensions each gap, and prints which office sets the minimum in Virginia.
