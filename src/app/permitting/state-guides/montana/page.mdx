...
<DataTable
  ...
  rows={[
    ...
    ["Building permit needed for your own home", "Yes inside certified cities/counties; often NO state permit in unincorporated non-certified areas (residential under 5 units is exempt under 50-60-104, MCA)"],
...
Montana's state building permit law contains an exemption list at [50-60-104, MCA](https://archive.legmt.gov/bills/mca/title_0500/chapter_0600/parts_index.html). The Bureau summarizes it on its [state building permit page](https://bsd.dli.mt.gov/building-codes-permits/permit-applications/building-permits/state-building-permit). Structures exempt from the **state** building permit include:
...
<DataTable
  ...
  headers={["Cost item", "Amount"]}
  rows={[
    ["State building permit", "$0 — single-family homes (under 5 units) are exempt under 50-60-104, MCA"],
