...
<CodeAlertCapture state="Nebraska" />
...
A to-scale drawing makes that conversation shorter: the free [Site Plan Studio](/site-plan-studio) will site the well and the system on the parcel, measure the distance between them, and print a letter-size sheet you can bring along.
