...
<DataTable
  ...
  rows={[
    ...
    ["Louisiana amendments (wind, flood, freeboard)", "Adopted by the LSUCCC; the freeboard amendment took effect Jan 1, 2023", "Strengthen the base IRC for hurricane wind and flood — see the hazard section below"]
  ]}
/>
...
2. **Flood freeboard**: After removing it in 2018, Louisiana **reinstated a freeboard requirement effective January 1, 2023** — generally one foot above base flood elevation for ordinary homes (more for critical structures); local floodplain managers may require more
...
<DataTable
  ...
  rows={[
    ...
    ["Electrical", "LSLBC", "Electrical contractor license required over $7,500 residential / $50,000 commercial"],
    ["Mechanical / HVAC", "LSLBC", "Mechanical classification (HVAC, refrigeration, ductwork are subclasses); required over roughly $10,000"],
...
<CalloutBox type="warning" title="Freeboard is back — build above base flood elevation">

After removing it in 2018, Louisiana **reinstated a statewide freeboard requirement effective January 1, 2023**: generally one foot above base flood elevation (BFE) for ordinary homes, with more for critical structures. Many parishes and the National Flood Insurance Program's Community Rating System push for even higher. Build high.

</CalloutBox>

Flood is the hazard that reshaped Louisiana construction after Katrina:

- **Find your BFE**: Your FEMA flood zone and base flood elevation dictate how high the lowest floor must be. A surveyor's elevation certificate documents it
- **Freeboard**: The LSUCC's reinstated amendment requires elevating above BFE (commonly +1 ft for homes; +2 ft for critical structures) — and going higher dramatically lowers flood-insurance premiums
...
- **ASCE 24**: Local floodplain managers may require freeboard, but never less than ASCE 24-14
...
2. **Build above the freeboard, not just to it**: Every foot over BFE pays you back in flood-insurance savings for the life of the home.
...
<FAQSection
  ...
  faqs={[
    ...
    },
    {
      ...
      answer: "Yes. In a FEMA flood zone, the lowest floor must be at or above the base flood elevation (BFE), and Louisiana reinstated a freeboard requirement effective January 1, 2023 — generally one foot above BFE for ordinary homes (more for critical structures), with parishes and the NFIP Community Rating System often requiring higher. In coastal V and Coastal A zones, open (pile) foundations with breakaway walls and flood-resistant materials are required. Building higher than the minimum also lowers your flood-insurance premiums."
    },
    {
