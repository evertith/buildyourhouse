...
<ArticleSchema path="/permitting/state-guides/connecticut" headline={"Connecticut Owner-Builder Permits 2026: Costs, Codes & Towns"} description={"Connecticut owner-builder permit guide 2026: 2022 CT State Building Code, town permit fees, owner-builder rights, radon, coastal flood and energy requirements. Plain-English breakdown."} />
...
<CodeAlertCapture state="Connecticut" />
...
The free [Site Plan Studio](/site-plan-studio) will put the well, the septic and its reserve area on a to-scale sheet before you settle on a location, measure each separation, and print the letter-size plot plan your town will ask for.
