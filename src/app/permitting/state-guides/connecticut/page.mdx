...
The [New Home Construction Contractor Act](https://www.cga.ct.gov/current/pub/chap_399a.htm) (Conn. Gen. Stat. §§ 20-417a to 20-417j) requires a **certificate of registration** from the Department of Consumer Protection for anyone who "engages in the business of new home construction" — defined as contracting with a *consumer* to construct or sell a new home for compensation. An owner building their own home has no consumer and no sale, so the Act doesn't reach them. DCP's own guidance confirms new home construction "does not include consumers building their own home."
