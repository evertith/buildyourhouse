export const metadata = {
  alternates: { canonical: '/permitting/state-guides/nevada' },
...
<ArticleSchema path="/permitting/state-guides/nevada" headline={"Nevada Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Nevada owner-builder permit guide 2026: NRS 624.031 owner-builder exemption, county IRC editions, permit costs, seismic and desert hazards. Plain-English breakdown for Las Vegas, Henderson, Reno and Carson City."} />
...
Drainage and grading review starts with a drawing, and the free [Site Plan Studio](/site-plan-studio) will put the lot, the house footprint and — on a rural parcel — the well and septic on one to-scale letter-size sheet with the separations dimensioned.
