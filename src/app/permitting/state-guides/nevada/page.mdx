...
<DataTable
  ...
  rows={[
    ...
    ["Licensed trades (if you hire out)", "Plumbing, electrical, and HVAC contractors must be NSCB-licensed; contracting/bidding $500+ without a license is a crime (NRS 624.700)"],
...
By law, anyone who contracts for or bids on a construction job valued at $500 or more (labor plus materials) must hold an NSCB license. Unlicensed contracting under [NRS 624.700](https://www.leg.state.nv.us/nrs/nrs-624.html) is a misdemeanor on the first offense, a gross misdemeanor on the second, and a Category E felony on the third or later — and a contract with an unlicensed contractor is void. Verify every sub's license at the NSCB before they touch your job.
