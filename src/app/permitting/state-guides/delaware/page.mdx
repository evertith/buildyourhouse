...
<CodeAlertCapture state="Delaware" />
...
Since the design has to come from a licensed designer either way, walk in with the layout already drawn — the free [Site Plan Studio](/site-plan-studio) puts the lot, house, well and drainfield on a to-scale letter-size sheet and dimensions every separation.
