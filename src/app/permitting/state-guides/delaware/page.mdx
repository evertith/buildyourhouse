...
<DataTable
  ...
  rows={[
    ...
    ["Energy code (statewide)", "2018 IECC, effective Dec 11, 2020; Delaware is entirely Climate Zone 4A"]
  ]}
/>
...
1. **Energy**: The [2018 IECC](https://dnrec.delaware.gov/climate-coastal-energy/efficiency/building-energy-codes/) is the statewide residential energy code, effective December 11, 2020. DNREC's State Energy Office administers it.
...
Unlike the building code, Delaware's energy code *is* statewide: the [2018 IECC](https://dnrec.delaware.gov/climate-coastal-energy/efficiency/building-energy-codes/), effective December 11, 2020. The entire state is Climate Zone 4A, so the envelope numbers below apply everywhere.

</CalloutBox>

<DataTable
  caption="Delaware residential energy requirements (2018 IECC, Climate Zone 4A, prescriptive path)"
  headers={["Component", "Requirement (Zone 4A)"]}
  rows={[
    ["Ceiling insulation", "R-49"],
    ["Wood-framed wall", "R-20 cavity or R-13 + R-5 continuous"],
    ["Basement wall", "R-13 cavity or R-10 continuous"],
    ["Crawl space wall", "R-13 cavity or R-10 continuous"],
    ["Windows (fenestration)", "U-0.32 max"],
    ["Air leakage", "≤3.0 ACH50 (2018 IECC residential)"]
  ]}
/>

<CalloutBox type="tip" title="Blower-door test is part of the package">

The 2018 IECC sets a 3.0 ACH50 air-leakage limit and requires a blower-door test to verify it on new homes. Plan and detail your air barrier from the start — sealing it after drywall is far harder and more expensive.
...
**Do I need a license to build my own house in Delaware?** No state general contractor competency license exists in Delaware, so building your own home as owner-builder is allowed. You still need a building permit from your county or city, and your home must meet that jurisdiction's adopted IRC edition plus the statewide 2018 IECC energy code. If you hire out the trades, the electrical, plumbing, and HVAC contractors are state-licensed.

**Is there a statewide building code in Delaware?** No. Building codes are adopted and enforced at the county and municipal level. New Castle County is on the 2024 IRC (effective Jan 1, 2026), Sussex County on the 2021 IRC, and Kent County on the 2018 IRC. The energy code (2018 IECC) is the main code set statewide.
...
<DataTable
  ...
  headers={["Phase", "Tasks"]}
  rows={[
    ["Months 1–2: Pre-permit", "Confirm jurisdiction and code edition; DNREC septic site evaluation (rural); well planning; architectural plans; 2018 IECC energy docs; flood-zone determination (coastal)"],
