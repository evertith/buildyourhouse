...
<DataTable
  ...
  headers={["Requirement", "Zone 4A (most of central & southern Missouri, including the Bootheel: St. Louis, Kansas City metro, Columbia)", "Zone 5A (northern Missouri + the Ozark plateau counties, including Greene/Springfield)"]}
  rows={[
...
A note that surprises people: Springfield and Greene County sit in **zone 5A**, colder than St. Louis and Kansas City in **4A**, because of elevation on the Ozark plateau. The Bootheel — the warmest part of the state — is still **4A**, not 3A.
...
- **Cons**: Zone 5A (colder) means more insulation; surrounding county uses older codes than the city
