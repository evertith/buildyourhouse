...
<ArticleSchema path="/permitting/state-guides/missouri" headline={"Missouri Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Missouri owner-builder permit guide 2026: no statewide building code, local permits and fees, owner-builder rights, New Madrid seismic zone and radon. Plain-English breakdown."} />
...
<CodeAlertCapture state="Missouri" />
...
Even in a county with no inspector, the drawing is worth making: the free [Site Plan Studio](/site-plan-studio) places the well and the absorption field to scale and dimensions the gap between them for the health authority's file.
