...
<ArticleSchema path="/permitting/state-guides/utah" headline={"Utah Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Utah owner-builder permit guide 2026: statewide Utah State Construction Code (2021 IRC), the owner-builder exemption, county fees, Wasatch Fault seismic and mountain snow loads. Plain-English breakdown."} />
...
A water right and a septic permit both start from the same drawing, and the free [Site Plan Studio](/site-plan-studio) will lay the well, the system and the house out to scale and dimension the gaps on a letter-size sheet.
