...
Mounds need room and the replacement area needs more, so lay it out to scale first — the free [Site Plan Studio](/site-plan-studio) will draw the POWTS, the well and the house on one letter-size sheet with the separations measured.
