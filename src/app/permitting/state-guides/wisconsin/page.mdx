...
6. **Radon**: No statewide mandate, but most of Wisconsin sits in EPA Radon Zone 1 — radon-resistant rough-in is strongly recommended (see the special section below)
...
<DataTable
  ...
  rows={[
    ...
    ["Outagamie (Appleton)", "Zone 1 — highest"],
    ["Rock, Walworth, Kenosha, Racine", "Zone 1 — highest"],
...
- **Cons**: Zone 1 radon; cold-climate detailing required
