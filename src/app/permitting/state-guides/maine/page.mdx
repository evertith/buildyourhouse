...
<DataTable
  ...
  rows={[
    ["State GC license to build your own home", "Not required — Maine has no statewide residential general contractor license (a new law, LD 1226, starts Jan 1, 2027 but exempts work on your own home)"],
...
### A Change Is Coming in 2027 — but It Exempts Your Own Home

In 2025 Maine enacted a new residential contractor licensing law (LD 1226) that takes effect **January 1, 2027**. It will require a state license for residential building contractors on projects above roughly $15,000 in contract price or involving two or more licensed trades. The law includes explicit exemptions — most importantly **for a person performing work on their own single-family home**, as well as for the already-licensed trades (electricians, plumbers).

<CalloutBox type="warning" title="The 2027 contractor-licensing law still protects owner-builders">

LD 1226 is aimed at *commercial* residential builders, not homeowners. Its owner-builder exemption is the same principle Maine has long used: you can build your own home. But the details (registration, paperwork, definitions) are still settling — if you're building in 2027 or later, confirm the current owner-builder exemption language with OPOR before you start.
...
<DataTable
  ...
  rows={[
    ...
    ["General contractor / framing / roofing", "Not state-licensed (residential GC license begins Jan 1, 2027 under LD 1226, with an owner's-own-home exemption)"]
  ]}
/>
...
**Do I need a license to build my own house in Maine?** No. Maine has no statewide general contractor license for residential work, so building your own home as an owner-builder is allowed. A new contractor-licensing law (LD 1226) begins January 1, 2027, but it specifically exempts work on your own single-family home. If you hire out electrical, plumbing, or heating-fuel work, those trades are state-licensed — though Maine lets you do that work yourself on your own primary residence.
...
5. **Watch the 2027 contractor law**: If you're building in 2027 or later, confirm the current owner-builder exemption under the new licensing law (LD 1226) with OPOR before you start. The exemption is real, but the paperwork is still settling.
  ...
  faqs={[
    {
      ...
      answer: "Yes. Maine has no statewide general contractor license for residential work, so you can legally act as your own general contractor on a home you own and occupy. If your town has more than 4,000 residents it enforces the Maine Uniform Building and Energy Code (MUBEC, based on the 2021 IRC) and you'll need a building permit; many smaller rural towns enforce no building code at all. A new contractor-licensing law (LD 1226) starts January 1, 2027 but exempts work on your own single-family home."
    },
    {
