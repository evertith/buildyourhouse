...
The Site Evaluator handles the soils, but the layout is still yours to sort out, and the free [Site Plan Studio](/site-plan-studio) will draw the lot, the system and the well to scale with every separation dimensioned before the HHE-200 goes in.
