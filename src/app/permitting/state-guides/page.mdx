...
<DataTable caption="Owner-builder permitting by state — at a glance (open each guide for full detail; cost framing varies by state)" headers={["State", "Building code", "Typical permit cost (2,000 sq ft)", "Owner-builder notes"]} rows={[
  ...
  ["New Jersey", "2021 IRC (statewide UCC)", "$1,400-$3,600 building + trade permits", "No GC license; DIY electrical/plumbing under NJAC 5:23-2.15"],
  ...
  ["North Dakota", "2021 IRC (locally adopted)", "$7,000-$18,000 metro / $0 rural", "Owner exempt under $4,000; state electrical/plumbing homeowner permits"],
