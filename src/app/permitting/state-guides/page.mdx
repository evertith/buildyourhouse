export const metadata = {
  alternates: { canonical: '/permitting/state-guides' },
...
**State permit kits:** where a guide has been turned into a printable filing kit — checklists, forms, and the inspection sequence with the statute citations on the page — it's noted here. [North Carolina is available now](/shop/nc-permit-kit) ($34); more states follow.
