...
Vermont has **high measured radon but no statewide radon-construction mandate** for single-family homes (with no structural code, there is no statewide passive-radon requirement). Importantly, despite the high readings, Vermont's counties are **not** classified in EPA Radon Zone 1 — but that classification understates the real risk here.

- The average indoor radon level in Vermont is about **6.0 pCi/L**, roughly 1.5 times the national average
- About **one in seven** Vermont homes has elevated radon
- Highest average levels are in **Rutland, Windsor, and Bennington** counties
