...
<CodeAlertCapture state="Vermont" />
...
That permit turns on a layout, so draw one early: the free [Site Plan Studio](/site-plan-studio) places the well, the system and the house to scale and dimensions the separations for your designer to work from.
