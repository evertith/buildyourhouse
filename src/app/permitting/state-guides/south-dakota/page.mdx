export const metadata = {
  alternates: { canonical: '/permitting/state-guides/south-dakota' },
...
<ArticleSchema path="/permitting/state-guides/south-dakota" headline={"South Dakota Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"South Dakota owner-builder permit guide 2026: no statewide building code (local enforcement only), no state GC license, state electrical and plumbing homeowner self-wire/self-plumb rules, deep frost, and very high radon. Plain-English breakdown for Sioux Falls, Rapid City, Aberdeen, and Brookings."} />
...
<DataTable
  ...
  rows={[
    ...
    ["Who enforces residential permits/code", "Local jurisdictions only; South Dakota has no statewide building code. Where adopted, 1-2 family homes follow the IRC (2021 in Sioux Falls, Rapid City, and Brookings)"],
...
<CodeAlertCapture state="South Dakota" />
...
<DataTable
  ...
  rows={[
    ...
    ["Brookings (city)", "2021 IRC", "2021 IECC"],
...
<DataTable
  ...
  headers={["Requirement", "Zone 6A (nearly all of SD: Sioux Falls, Rapid City, Pierre, Aberdeen, Yankton)", "Zone 5A (far southern edge only)"]}
  rows={[
    ["Ceiling insulation", "R-49 to R-60", "R-49"],
    ["Wood-framed wall", "R-20+5 or R-13+10 continuous", "R-20 cavity or R-13 + R-5 continuous"],
    ["Slab edge", "R-10 to 48\" (Zone 6 slab perimeter)", "R-10 to 24\" below grade"],
...
- **Continuous insulation and air sealing** — Zone 6A envelopes statewide (a 5A sliver on the far southern edge), even where no IECC is enforced
...
Get the layout on paper before that evaluation — the free [Site Plan Studio](/site-plan-studio) draws the lot to scale, measures well-to-drainfield, and prints a sheet the county zoning office can read.
