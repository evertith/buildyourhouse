...
<ArticleSchema path="/permitting/state-guides/new-york" headline={"New York Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"New York owner-builder permit guide 2026: 2025 Residential Code of New York State, the separate NYC Construction Codes, local trade licensing, snow loads, the all-electric law and permit costs. Plain-English breakdown."} />
...
<CodeAlertCapture state="New York" />
...
It costs nothing to draw the layout first — the [Site Plan Studio](/site-plan-studio) places the well, tank and absorption field to scale, measures the separations, and prints a letter-size sheet the county reviewer can put a rule on.
