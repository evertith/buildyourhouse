export const metadata = {
  alternates: { canonical: '/permitting/state-guides/iowa' },
...
<ArticleSchema path="/permitting/state-guides/iowa" headline={"Iowa Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"Iowa owner-builder permit guide 2026: Iowa State Building Code (2024 IRC), county fees, owner-builder rights, the homeowner trade exemption, radon and energy requirements. Plain-English breakdown."} />
...
Because that inspection follows the property, keep an accurate record of what went in the ground: the [Site Plan Studio](/site-plan-studio) is free, draws the well and system to scale, and prints a dimensioned letter-size sheet worth filing with the deed.
