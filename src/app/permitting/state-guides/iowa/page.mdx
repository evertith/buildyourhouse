...
<DataTable
  ...
  rows={[
    ...
    ["DIY electrical & plumbing on an EXISTING home", "Allowed without a license if the home qualifies for the homestead tax exemption and is single-family (Iowa Code 103.22 / 105.11)"],
...
<DataTable
  ...
  rows={[
    ["Iowa State Building Code (incorporates the 2024 IRC)", "Adopted via Iowa Administrative Code ch. 301; authority is Iowa Code ch. 103A; Des Moines and most metros adopted the 2024 I-Codes effective Jan 1, 2026", "One- and two-family dwellings and townhouses"],
    ["2024 International Building Code (IBC)", "Adopted statewide / by metros on the 2024 cycle", "Non-residential"],
    ["Iowa Residential Energy Code", "2012 IECC with Iowa amendments (661 IAC 303.2) is the statewide baseline; some metros (e.g., Des Moines) reference a newer IECC edition", "Residential energy"],
...
*Last updated: May 2026. Verified this update: Iowa has no statewide general contractor competency license, but it state-licenses the electrical trade (Iowa Electrical Examining Board, [Iowa Code ch. 103](https://www.legis.iowa.gov/docs/code/103.22.pdf)) and the plumbing/mechanical/HVAC/hydronic/refrigeration trades (Iowa Plumbing & Mechanical Systems Board, [Iowa Code ch. 105](https://www.legis.iowa.gov/docs/ico/chapter/105.pdf)); the homeowner DIY exemptions in § 103.22 and § 105.11 apply only to existing, homestead-qualified, single-family residences and not to new construction. Homes follow the Iowa State Building Code, which incorporates the 2024 IRC (Iowa Administrative Code ch. 301; authority [Iowa Code ch. 103A](https://www.legis.iowa.gov/docs/ico/chapter/103A.pdf)), adopted by Des Moines and most metros effective Jan 1, 2026; the residential energy baseline is the 2012 IECC with Iowa amendments (661 IAC 303.2). Iowa has the highest average indoor radon in the U.S. — 8.5 pCi/L with all 99 counties in EPA Zone 1, per the [Iowa HHS/IDPH radon program](https://hhs.iowa.gov/health-prevention/providers-professionals/radiological-health/radon) — and seller radon disclosure is governed by [Iowa Code ch. 558A](https://www.legis.iowa.gov/docs/ico/chapter/558A.pdf). Permit fees, the exact adopted code and NEC editions, frost depth, radon ordinances, and homeowner trade rules all vary by jurisdiction — verify with your specific county or municipal building department before relying on any figure here.*
