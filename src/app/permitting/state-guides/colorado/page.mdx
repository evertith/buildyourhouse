export const metadata = {
  title: 'Colorado Owner-Builder Permit Guide 2026 | CO Building Permit Requirements',
  description: 'Complete guide to Colorado owner-builder permits. CO building codes, mountain construction, permit costs, and owner-builder laws for building in Colorado.',
