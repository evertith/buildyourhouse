...
<ArticleSchema path="/permitting/state-guides/new-jersey" headline={"New Jersey Owner-Builder Permits 2026: Costs, Codes & Counties"} description={"New Jersey owner-builder permit guide 2026: statewide Uniform Construction Code (UCC), DCA administration, homeowner trade exemption, county fees, coastal flood and radon rules. Plain-English breakdown."} />
...
<CodeAlertCapture state="New Jersey" />
...
Before that evaluation, put the parcel on paper: the free [Site Plan Studio](/site-plan-studio) draws the lot, house, well and disposal field to scale and writes the separation between each of them on the sheet.
