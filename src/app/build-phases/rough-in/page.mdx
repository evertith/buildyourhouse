...
<ArticleSchema path="/build-phases/rough-in" headline={"Rough-In Phase: Coordinating Plumbing, Electrical & HVAC"} description={"How to sequence and coordinate the three rough-in trades. Scheduling tips, inspection prep, and what to check before drywall goes up."} />
