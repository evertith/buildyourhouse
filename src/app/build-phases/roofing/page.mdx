export const metadata = {
  title: 'Roofing Installation Guide - DIY House Roofing Instructions',
  description: 'Complete roofing guide for owner-builders. Shingle installation, costs, timeline, and step-by-step instructions for roofing a house.',
};
...
💡 **TIP**: Ice and water shield is expensive but critical. It's self-sealing around nails and creates waterproof barrier. Don't skip this - it prevents 90% of leak issues.
...
⚠️ **WARNING**: Proper nailing is critical. Nails must hit sheathing (not just skip sheathing). Overdriven nails break the seal. Under-driven nails don't seal. Improper nailing is the #1 cause of shingle failure.
...
💡 **TIP**: Use open metal valleys for best performance. Yes, they cost $200-$400 more, but valley leaks are the most common roof failure point.
...
💡 **TIP**: Many owner-builders hire roofing out. The $3,500-$6,000 labor premium buys expertise, speed (2 days vs 2 weeks), safety, and warranty. This is often money well spent.
...
[Schedule a Roofing Consultation](/consulting)
