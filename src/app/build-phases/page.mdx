export const metadata = {
  title: 'Complete House Building Timeline - 16 Essential Phases',
  description: 'Step-by-step house building phases from site prep to landscaping. Timeline, costs, and difficulty for each phase of construction.',
};
...
This guide provides the complete roadmap for building a house from raw land to move-in ready, with realistic timelines and cost estimates based on managing hundreds of custom home builds.
