export const metadata = {
  alternates: { canonical: '/build-phases/interior-trim' },
...
<ArticleSchema path="/build-phases/interior-trim" headline={"Interior Trim \u2014 Baseboards, Door Casings & Crown Molding"} description={"How to install baseboards, door trim, window casings, and crown molding. Material costs, tools, and techniques for clean results."} />
...
<Checklist
  storageKey="interior-trim-checklist"
  items={[
...
Interior trim requires patience and precision but is very DIY-able. Practice coping joints and complex crown cuts on offcuts before you touch your finish stock. Questions on the guide? [Get in touch](/contact).
