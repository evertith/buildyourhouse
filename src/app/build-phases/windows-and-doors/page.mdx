...
- **IRC R308.4 - Safety glazing**: Glass in "hazardous locations" must be safety glazing (tempered or laminated). This includes glazing in and adjacent to doors, near tubs/showers, and at stairs/landings (see the callout below). Verify the specifics against your jurisdiction's adopted code edition.
