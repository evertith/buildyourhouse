export const metadata = {
  alternates: { canonical: '/build-phases/windows-and-doors' },
...
<ArticleSchema path="/build-phases/windows-and-doors" headline={"Window & Door Installation \u2014 Sizing, Flashing & Cost Breakdown"} description={"How to install windows and exterior doors correctly. Flashing details that prevent leaks, costs by type, and common owner-builder mistakes."} />
...
<Checklist
  storageKey="windows-and-doors-checklist"
  items={[
...
Proper flashing is critical to preventing water damage. Follow the manufacturer's flashing sequence exactly, and if you're unsure, have an experienced installer check your first opening before you do the rest. Questions on the guide? [Get in touch](/contact).
