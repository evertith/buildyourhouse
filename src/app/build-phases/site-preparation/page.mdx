export const metadata = {
  alternates: { canonical: '/build-phases/site-preparation' },
...
<ArticleSchema path="/build-phases/site-preparation" headline={"Site Preparation: Costs, Timeline & What Happens Before You Build"} description={"What site prep actually involves, what it costs ($1,500\u2013$30,000+), and how to avoid expensive surprises before breaking ground."} />
...
<DataTable
  caption="Site preparation at a glance"
...
<CalloutBox type="warning" title="Drainage is where the money gets lost">
...
<CalloutBox type="warning" title="Call 811 before you dig">
...
<CalloutBox type="tip" title="Keep your topsoil">
...
<CalloutBox type="warning" title="Cost consideration">
...
<CalloutBox type="critical" title="Grade water away from the foundation">
...
<DataTable
  caption="Minimum utility trench depths and slope per code"
  headers={["Utility", "Minimum requirement"]}
  rows={[
...
<CalloutBox type="tip" title="Sleeve the driveway now">
...
<CalloutBox type="warning" title="Foundation layout must be exact">
...
<DataTable
  caption="Typical site-work subcontractor pricing"
...
<CalloutBox type="tip" title="Get three bids">
...
<CalloutBox type="critical" title="These are the expensive ones">
...
<CalloutBox type="success" title="Don't pour until every box is checked">
...
<Checklist
  storageKey="site-preparation-checklist"
  items={[
...
<CalloutBox type="tip" title="Site costs vary enormously — get local bids">
...
<CalloutBox type="info" title="Best season">
...
<CalloutBox type="info" title="Up next: the foundation">
...
Before the excavator shows up, get the lot on paper: the free [Site Plan Studio](/site-plan-studio) draws the parcel, house, driveway, well and septic to scale, so the grading and utility runs get decided on a drawing instead of in the dirt.

<CalloutBox type="tip" title="A site visit can save you thousands">

If you're unsure about drainage, utility placement, or grading, a site visit from a civil engineer or excavation contractor can save you thousands later. The [securing-land due-diligence guide](/planning/secure-land) covers what to check before you break ground; [get in touch](/contact) with questions.
