export const metadata = {
  title: 'Site Preparation Guide - First Phase of Building a House',
  description: 'Complete guide to site preparation and clearing. Costs, timeline, and step-by-step process for preparing land to build a house.',
};
...
⚠️ **WARNING**: Always call 811 at least 48 hours before digging. Hitting utilities can be deadly and costs $10,000+ to repair. It's free and required by law.
...
💡 **TIP**: Stockpile topsoil separately from subsoil. You'll need it for final grading and landscaping. Good topsoil is worth $25-$40 per yard to replace.
...
🚨 **CRITICAL**: Grading must direct water AWAY from the foundation. This is code-required and prevents 90% of foundation water issues.
...
💡 **TIP**: Sleeve driveways with extra conduit now. Adding communication lines later requires cutting through your new driveway. I always run 2-3 extra 2" conduits for future use.
...
⚠️ **WARNING**: Foundation layout must be exact. A 1" error here becomes a major problem when walls don't fit. Verify diagonal measurements - they should match if corners are square.
...
💡 **TIP**: Get at least 3 bids and check references. The lowest bid often comes from someone who forgot something major. Middle bid is usually your best value.
...
💡 **TIP**: Site costs vary enormously by location, soil conditions, and utility access. Get local bids before finalizing your budget. I've seen similar lots range from $15,000 to $60,000.
...
[Schedule a Site Planning Consultation](/consulting)
