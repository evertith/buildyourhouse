...
- The maximum trap-to-vent distance is set by the **trap-arm (drain) size**, not the fixture type. Under the IPC (Table 909.1), typical maximum developed lengths are:
  - 1.5" trap arm: 6 feet
  - 2" trap arm: 8 feet
  - 3" trap arm: 12 feet
  - Water closets are exempt—self-siphoning fixtures have **no** distance limit (IPC 909.1)
