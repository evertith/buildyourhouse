...
<ArticleSchema path="/build-phases/plumbing-rough-in" headline={"Plumbing Rough-In \u2014 Supply Lines, Drains & Venting Explained"} description={"Water supply, drain-waste-vent layout, and code requirements for plumbing rough-in. Costs, common mistakes, and inspection tips."} />
...
<Checklist
  storageKey="plumbing-rough-in-checklist"
  items={[
...
Plumbing rough-in is complex with strict code requirements. Review the [rough-in inspection guide](/inspections/rough-in-inspections) for what inspectors check, and have a licensed plumber verify your venting and pipe sizing before you close walls. Questions on the guide? [Get in touch](/contact).
