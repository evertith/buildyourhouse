export const metadata = {
  title: 'Interior Finish Work: Transform Your House Into a Home',
  description: 'Complete guide to interior finish phase for owner-builders. Learn trim, flooring, kitchen, bathroom finishes, and final details.',
};
