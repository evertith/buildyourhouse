...
<ArticleSchema path="/build-phases/final-finishes" headline={"Final Finishes & Punch List \u2014 The Last Steps Before Move-In"} description={"Hardware, fixtures, touch-ups, and the punch list process. How to wrap up your build and prepare for your final inspection."} />
...
Final finishes involve dozens of small tasks. Use the [punch-list template](/move-in/punch-list) to track them and the [final inspection guide](/inspections/final-inspection) to make sure you're ready for sign-off. Still stuck on something specific? [Get in touch](/contact).
