...
- **IRC R302.5.1 - Dwelling/garage door**: The door between the garage and the house must be a 1-3/8" solid wood or solid/honeycomb-core steel door, or a 20-minute fire-rated door, and must be self-latching with a self-closing or automatic-closing device. (Verify against your jurisdiction's adopted code edition.)
