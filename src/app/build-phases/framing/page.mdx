export const metadata = {
  alternates: { canonical: '/build-phases/framing' },
...
<ArticleSchema path="/build-phases/framing" headline={"House Framing Guide \u2014 Costs, Timeline & Step-by-Step Process"} description={"Floor, wall, and roof framing explained for owner-builders. Material costs, labor estimates, and the critical details inspectors check."} />
...
The free [Framing Lumber Calculator](/calculators/framing-lumber) turns your footprint into stud, plate, header, and sheathing counts — with the formulas shown — before you price this phase.
...
- Ordering windows and doors — 8-12 weeks out (see [material lead times](/timing-and-scheduling/material-lead-times))
...
<Checklist
  storageKey="framing-checklist-2"
  items={[
...
Framing is DIY-able but complex. Build to your approved plans, use the [framing inspection guide](/inspections/framing-inspection) to self-check before the inspector arrives, and have an engineer confirm anything structural you're unsure about. Questions on the guide? [Get in touch](/contact).
