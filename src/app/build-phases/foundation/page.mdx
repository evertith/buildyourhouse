export const metadata = {
  title: 'Foundation Construction Guide - Complete Owner-Builder Guide',
  description: 'Complete foundation building guide. Types, costs, timeline, and step-by-step instructions for building a house foundation.',
};
...
| Item | Quantity (2,000 sq ft) | Typical Cost | Notes |
|------|---------------------|--------------|-------|
...
⚠️ **WARNING**: Rebar placement is critical. Too close to bottom or edges reduces strength significantly. Maintain 3" clear cover on all sides.
...
🚨 **CRITICAL**: Must pass footing inspection before covering with walls. Inspection verifies depth, width, and rebar placement.
...
💡 **TIP**: Rent or buy quality forms if doing this yourself. Forms must be very strong and well-braced. I've seen weak forms blow out mid-pour - it's a disaster that wastes $3,000+ in concrete.
...
🚨 **CRITICAL**: Concrete sets in 30-60 minutes and hardens in 3-4 hours. Work quickly and systematically. Once it starts hardening, you cannot reposition anchor bolts or fix problems.
...
💡 **TIP**: Proper waterproofing and drainage prevents 95% of foundation water problems. This $800 investment saves $15,000+ in repairs later.
...
⚠️ **WARNING**: Do not start framing until foundation inspection passes. Inspectors will make you remove framing to verify foundation details.
...
**How to avoid**: Follow code (maximum 6 feet on center, within 12" of corners/openings). Verify before concrete sets.
...
💡 **TIP**: Most owner-builders should budget for hired labor on foundations. The $6,000-$11,000 premium buys expertise, speed, and warranty protection on your most critical building component.
...
[Schedule a Foundation Planning Consultation](/consulting)
