...
- **SEER2** (the current cooling-efficiency metric): Since January 1, 2023 the federal minimums are expressed in SEER2 (a revised test method) and split by region:
  - **North**: 13.4 SEER2 minimum (roughly the old 14 SEER)
  - **South and Southwest**: 14.3 SEER2 minimum for systems under 45,000 BTU (roughly the old 15 SEER)
  - Good: ~15-17 SEER2
  - Excellent: ~19+ SEER2
  - Roughly each 2 SEER2 increase = ~10% cooling-energy savings
  - SEER2 numbers run a bit lower than the old SEER for the same equipment—don't compare them one-to-one. Verify the current minimum for your region, since standards change
...
- Stepping up roughly 2 SEER2 (e.g., from the regional minimum to the next tier): Added cost $500-$1,000, payback 3-7 years
- 80% to 95% AFUE furnace: Added cost $800-$1,500, payback 5-10 years

**My recommendation**: Meet or beat your region's SEER2 minimum—stepping one tier above it (and pairing with a 92%+ AFUE furnace) is usually worth the small upfront premium in lower bills. Confirm the current minimum for your region before you buy.
