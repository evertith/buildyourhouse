export const metadata = {
  alternates: { canonical: '/build-phases/electrical-rough-in' },
...
<ArticleSchema path="/build-phases/electrical-rough-in" headline={"Electrical Rough-In \u2014 Panel Sizing, Circuits & Code Requirements"} description={"Electrical rough-in explained: panel sizing, circuit planning, wire runs, and NEC code requirements. What your inspector will check."} />
...
<Checklist
  storageKey="electrical-rough-in-checklist"
  items={[
...
Electrical work requires code knowledge but is very DIY-able. The [rough-in inspection guide](/inspections/rough-in-inspections) covers what the inspector checks; for load calculations or panel work, have a licensed electrician review your plan. Questions on the guide? [Get in touch](/contact).
