...
- **Laundry**: One 20A circuit (GFCI required under the 2020+ NEC—verify your adopted edition and local rules)
...
**Box placement heights** (typical trade conventions, not NEC-mandated heights for general receptacles—the code rarely dictates an exact height; pick consistent heights and check local amendments):
- **Wall receptacles**: 12-18" above finish floor is the common convention (often 16")
- **Kitchen counter**: 44" above floor (about 4" above counter) is typical—note the code limits counter receptacles to no more than 20" above the countertop (NEC 210.52(C))
- **Bathroom**: 44" above floor is typical
- **Switches**: 48" above floor is a common convention
- For accessibility (ADA), receptacles generally must be at least 15" above the floor and switches no higher than 48"—verify your adopted NEC edition and local rules
...
Key IRC and NEC electrical requirements. Code numbers and thresholds change between editions—always verify your adopted NEC/IRC edition and local rules before relying on any of these:
