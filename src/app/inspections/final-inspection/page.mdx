export const metadata = {
  title: 'Final Inspection Guide - Get Your Certificate of Occupancy',
  description: 'Complete guide to passing your final building inspection. Learn what inspectors check, common failure points, and how to get your CO on first try.',
};
...
<CalloutBox type="warning" title="100% Complete Means 100%">
...
<CalloutBox type="tip" title="Don't Rush Final">
...
<CalloutBox type="warning" title="#1 Failure: Smoke/CO Detectors">
...
<table className="dataTable">
  ...
  <tbody>
    <tr>
      <td><strong>1. Smoke/CO Detectors Not Interconnected</strong><br/>Missing detectors or not wired to sound together</td>
      <td>IRC R314<br/>IRC R315</td>
      <td>Install missing detectors, ensure all interconnected and tested</td>
      <td>1-3 days</td>
      <td className="numeric">$200-$600</td>
    </tr>
    <tr>
      <td><strong>2. Missing or Improper Handrails</strong><br/>No handrail on stairs or not code-compliant</td>
      <td>IRC R311.7.8</td>
      <td>Install code-compliant handrail (34-38" height, graspable)</td>
      <td>3-5 days</td>
      <td className="numeric">$300-$1,200</td>
    </tr>
    <tr>
      <td><strong>3. Guards Missing or Balusters Too Wide</strong><br/>No guard at elevated surface or spacing too wide</td>
      <td>IRC R312</td>
      <td>Install guards (36" min height, 4" sphere test)</td>
      <td>3-7 days</td>
      <td className="numeric">$500-$2,500</td>
    </tr>
    <tr>
      <td><strong>4. Garage Door Auto-Reverse Not Working</strong><br/>Door doesn't reverse when meeting obstruction</td>
      <td>UL 325</td>
      <td>Adjust opener sensitivity or replace opener</td>
      <td>1-3 days</td>
      <td className="numeric">$100-$400</td>
    </tr>
    <tr>
      <td><strong>5. Missing Electrical Cover Plates</strong><br/>Outlets or switches without cover plates</td>
      <td>NEC 406.5</td>
      <td>Install all missing cover plates</td>
      <td>1-2 days</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td><strong>6. Electrical Panel Not Labeled</strong><br/>Breakers not labeled indicating what they control</td>
      <td>NEC 408.4</td>
      <td>Label all breakers properly with circuit directory</td>
      <td>1-2 days</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td><strong>7. Plumbing Leak</strong><br/>Active leak at fixture, supply line, or drain</td>
      <td>Various</td>
      <td>Repair leak (common: under sinks, toilets, showers)</td>
      <td>1-3 days</td>
      <td className="numeric">$100-$500</td>
    </tr>
    <tr>
      <td><strong>8. HVAC Not Operational</strong><br/>Heating or cooling system not working</td>
      <td>Various</td>
      <td>Complete HVAC startup, charge refrigerant, verify operational</td>
      <td>2-5 days</td>
      <td className="numeric">$200-$800</td>
    </tr>
    <tr>
      <td><strong>9. Missing Tempered Glass</strong><br/>Regular glass in hazardous location</td>
      <td>IRC R308.4</td>
      <td>Replace with tempered glass (near doors, tubs, walking surfaces)</td>
      <td>3-7 days</td>
      <td className="numeric">$300-$1,500</td>
    </tr>
    <tr>
      <td><strong>10. Grading Not Sloping Away</strong><br/>Ground slopes toward foundation or doesn't slope enough</td>
      <td>IRC R401.3</td>
      <td>Regrade (6" drop in 10' away from foundation)</td>
      <td>3-7 days</td>
      <td className="numeric">$800-$3,000</td>
    </tr>
    <tr>
      <td><strong>11. Missing TPR Discharge Pipe</strong><br/>Water heater T&P relief valve discharge not proper</td>
      <td>IRC P2804</td>
      <td>Install discharge pipe (6-24" above floor, no threads on end)</td>
      <td>1-2 days</td>
      <td className="numeric">$100-$300</td>
    </tr>
    <tr>
      <td><strong>12. Bathroom Ventilation Not Working</strong><br/>Exhaust fan not working or not vented to exterior</td>
      <td>IRC R303.3</td>
      <td>Connect fan, verify venting to exterior (not attic)</td>
      <td>2-4 days</td>
      <td className="numeric">$200-$600</td>
    </tr>
    <tr>
      <td><strong>13. Missing Address Numbers</strong><br/>House number not posted or not visible from street</td>
      <td>IRC R319.1</td>
      <td>Install address numbers (4" high min, visible, contrasting)</td>
      <td>1-2 days</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td><strong>14. Egress Window Not Operational</strong><br/>Required bedroom window won't open fully</td>
      <td>IRC R310</td>
      <td>Make window operational (can't be painted shut)</td>
      <td>1-3 days</td>
      <td className="numeric">$100-$500</td>
    </tr>
    <tr>
      <td><strong>15. Work Not Complete</strong><br/>Finish work incomplete (trim, paint, flooring)</td>
      <td>Various</td>
      <td>Complete all finish work and punch list items</td>
      <td>5-14 days</td>
      <td className="numeric">$1,000-$5,000+</td>
    </tr>
  </tbody>
</table>

<CalloutBox type="tip" title="Test Everything Before Inspector Arrives">
...
<CalloutBox type="info" title="Don't Panic - This Is Normal">
...
<table className="dataTable">
  ...
  <tbody>
    <tr>
      ...
      <td>Install/interconnect all detectors, test</td>
      <td>1-3 days</td>
      <td className="numeric">$200-$600</td>
    </tr>
    <tr>
      <td>Missing handrail</td>
      <td>Install code-compliant handrail</td>
      <td>3-5 days</td>
      <td className="numeric">$300-$1,200</td>
    </tr>
    <tr>
      <td>Cover plates</td>
      <td>Install all missing plates</td>
      <td>1 day</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td>Panel labeling</td>
      <td>Label all breakers in directory</td>
      <td>1 day</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td>Plumbing leak</td>
      <td>Repair leak, verify no drips</td>
      <td>1-3 days</td>
      <td className="numeric">$100-$500</td>
    </tr>
    <tr>
      <td>Garage auto-reverse</td>
      <td>Adjust opener sensitivity</td>
      <td>1-2 days</td>
      <td className="numeric">$100-$400</td>
    </tr>
    <tr>
      <td>Address numbers</td>
      <td>Install visible numbers</td>
      <td>1 day</td>
      <td className="numeric">$50-$150</td>
    </tr>
    <tr>
      <td>Grading issues</td>
      <td>Regrade around foundation</td>
      <td>3-7 days</td>
      <td className="numeric">$800-$3,000</td>
    </tr>
  </tbody>
...
<CalloutBox type="warning" title="Safety Items Are Non-Negotiable">
...
<Checklist
  ...
  items={[
    ...
    'Garage door auto-reverse working (test with 2x4)',
...
<Checklist
  ...
  items={[
    ...
    'Water heater TPR discharge pipe installed (6-24" above floor)',
...
<CalloutBox type="tip" title="Do Your Own Pre-Final Inspection">
...
<CalloutBox type="tip" title="Test Everything Yourself First">
...
<CalloutBox type="tip" title="Document Everything Working">
...
- Some jurisdictions require formal permit close-out
- Return any posted permits if required
- Get final as-built inspection report
- File for permanent records

### Warranty Period Begins

- Most jurisdictions have 1-year warranty period
- If issues arise that are code violations, building department may require correction
...
**Want a pre-final inspection review?** Our [on-site inspection prep service](/consulting) includes comprehensive pre-final walk-through, punch list development, and code compliance verification. We'll identify any issues before the official final inspection, helping ensure you pass on first try and get your CO without delay. After building your own home, you deserve to move in on schedule.

**Congratulations on building your house!** Getting to final inspection is a massive achievement.
