...
- Peninsulas and islands: required to have receptacles under the 2020 NEC, but **optional** under the 2023 NEC (which instead may only require a provision—roughed-in wiring—for a future outlet). Check which NEC edition your jurisdiction enforces.
...
**Dryer vent** (IRC M1502.4.5 — verify your jurisdiction's adopted edition):
- Maximum 35' total developed length (reduced for fittings per Table M1502.4.5.1: typically -2.5' per 45°, -5' per 90°)
- Always follow the dryer manufacturer's installation instructions if they are more restrictive
- Minimum 4" diameter
