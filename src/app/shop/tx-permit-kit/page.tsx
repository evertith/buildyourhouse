...
const TX: KitContent = {
  slug: 'tx-permit-kit',
  heroSub:
    'No state contractor license and no state building permit — and the trade-licensing, septic, energy-code, and windstorm rules that bind you anyway. Both tracks, city and county, verified against the statutes with the citations printed on the page.',
  pageCount: 33,
  ...
  highlightsLead:
    'Four things in this kit that most Texas owner-builder advice gets wrong. Each one is checkable in a couple of minutes — which is the point of printing the citation. If you want the lay of the land first, the free Texas owner-builder guide covers it; the kit is the working version.',
  ...
  sourceNote:
    'Verified against statutes.capitol.texas.gov, TDLR, TCEQ, TDI, and city permitting sources, August 2026 · Citations printed on each page',
  ...
  verifyNote:
    'Statutes and code editions change, and Texas cities amend everything locally. Confirm each rule with your city or county — the kit prints its sources so you can.',
...
export default function TXPermitKit() {
  return <KitProductPage content={TX} />;
}
