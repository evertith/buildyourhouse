...
**Important — check your state first:** Several states (CA, TX, AZ, GA, NV, UT, FL, MS, MO, WY) require their exact statutory waiver form. In those states a custom form like the ones below is unenforceable—you must use your state's official form. Treat these templates as examples for non-statutory states or for understanding the structure; verify your jurisdiction's requirements before relying on them.
