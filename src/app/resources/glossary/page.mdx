...
<CalloutBox type="info" title="How to use this glossary">
...
<DataTable caption="A — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="B — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="C — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="D — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="E — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="F — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="G — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="H — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="I — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="J — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="K — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="L — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="M — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="N — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="O — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="P — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="Q — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="R — construction terms" headers={["Term", "Definition"]} rows={[
  ...
  ["Receptacle", "The device you plug cords into. Per NEC Article 100, a receptacle is one type of \"outlet\" — \"outlet\" is the broader term that also covers lighting and hardwired connections."],
...
<DataTable caption="S — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="T — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="U — construction terms" headers={["Term", "Definition"]} rows={[
  ["U-Factor", "Whole-assembly rate of heat transfer through a window (frame, spacer, and glass together), measured under NFRC procedures. Lower U-factor = better insulation. U and R are reciprocal as units (U = 1/R), but a window's rated U-factor is not simply the inverse of an insulation R-value."],
...
<DataTable caption="V — construction terms" headers={["Term", "Definition"]} rows={[
  ...
  ["Variance", "Permission from a zoning board of appeals to deviate from a ZONING ordinance (e.g., setback, height, or lot-coverage rules) based on a unique property hardship. It does not apply to building-code requirements."],
...
<DataTable caption="W — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="Z — construction terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="Owner-Builder Specific Terms" headers={["Term", "Definition"]} rows={[
...
<DataTable caption="Code and Permitting Terms" headers={["Term", "Definition"]} rows={[
...
- [Building Code Guide](/permitting/understanding-building-codes) - Understand code applications
- [Templates and Forms](/resources/templates) - See terms used in contracts
- [Subcontractor Selection](/subcontractors/vetting-and-interviewing) - Speak their language
- [Inspection Guides](/inspections/foundation-inspection) - Know what inspectors look for
