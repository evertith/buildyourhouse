export const metadata = {
  title: 'Home Build Timing & Scheduling Guide - Realistic Timelines for Owner-Builders',
  description: 'Master construction scheduling and timing for your owner-builder project. Learn realistic timelines, critical path scheduling, and how to avoid costly delays.',
};
