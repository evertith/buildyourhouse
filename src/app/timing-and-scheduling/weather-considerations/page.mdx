export const metadata = {
  title: 'Weather Considerations for Home Building - Seasonal Construction Planning',
  description: 'Plan your home build around weather. Learn which tasks are weather-dependent, best construction seasons, and how to minimize weather delays.',
};
