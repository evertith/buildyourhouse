...
<Checklist
  storageKey="weather-considerations-checklist"
  items={[
...
<Checklist
  storageKey="weather-considerations-checklist-2"
  items={[
...
<Checklist
  storageKey="weather-considerations-checklist-3"
  items={[
...
<Checklist
  storageKey="weather-considerations-checklist-4"
  items={[
    'Check 2-day forecast (no rain)',
