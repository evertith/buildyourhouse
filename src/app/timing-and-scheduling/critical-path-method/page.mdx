export const metadata = {
  alternates: { canonical: '/timing-and-scheduling/critical-path-method' },
...
<Checklist
  storageKey="critical-path-method-checklist"
  items={[
...
<Checklist
  storageKey="critical-path-method-checklist-2"
  items={[
...
<Checklist
  storageKey="critical-path-method-checklist-3"
  items={[
