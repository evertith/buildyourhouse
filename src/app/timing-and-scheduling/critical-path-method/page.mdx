export const metadata = {
  title: 'Critical Path Scheduling — Know Which Tasks Control Your Timeline',
  description: 'Identify the tasks that control your completion date. Critical path method explained simply for owner-builders with practical examples.',
};
...
<CalloutBox type="tip" title="The core idea">

A handful of tasks control your completion date. Find them, guard them, and stop losing sleep over everything else.
...
<DataTable
  caption="How a one-week slip plays out depending on the task"
  headers={["Delay this task by 1 week", "Project impact"]}
  rows={[
    ["Framing", "Project delayed 1 week"],
    ["Rough-ins", "Project delayed 1 week"],
    ["Siding", "No impact (still has 7 weeks of float)"]
  ]}
/>
...
<CalloutBox type="warning" title="Same $2,000, very different outcomes">

You have $2,000 to accelerate the schedule:
...
<DataTable
  caption="Example task dependencies"
  headers={["Task", "Requires"]}
  rows={[
    ["Framing", "Foundation complete"],
    ["Rough-in", "Framing complete, dried in"],
    ["Drywall", "Rough-ins complete and inspected"],
    ["Cabinets", "Drywall finished, painted"],
...
<DataTable
  caption="Path A — main interior sequence (2,000 sq ft home)"
...
<DataTable
  caption="Path B — exterior sequence (2,000 sq ft home)"
  headers={["Task", "Duration"]}
  rows={[
    ["Site work", "2 weeks"],
    ["Foundation", "4 weeks"],
...
<DataTable
  caption="Path C — flooring sequence (2,000 sq ft home)"
  headers={["Task", "Duration"]}
  rows={[
...
<CalloutBox type="critical" title="These are your focus areas">

Any delay to a critical-path task delays project completion. Guard them first.
...
<DataTable
  caption="Common residential critical path — duration and float"
  headers={["Step", "Phase", "Duration", "Float"]}
  rows={[
    ["1", "Permits and Approvals", "4-12 weeks", "Zero"],
    ["2", "Foundation", "3-5 weeks", "Zero"],
    ["3", "Framing", "4-8 weeks", "Zero to minimal"],
    ["4", "Rough-Ins", "4-8 weeks", "Minimal"],
    ["5", "Insulation and Drywall", "4-6 weeks", "Zero"],
    ["6", "Cabinets", "1-3 weeks install", "Minimal"],
    ["7", "Countertops", "3-5 days install", "Minimal"],
    ["8", "Final Inspection", "1 day inspection, 1-2 weeks prep", "Zero"]
  ]}
/>
...
<CalloutBox type="tip" title="These tasks have float — use it">

The tasks below typically have float and can be delayed without impacting completion. Watch the exceptions, which are mostly weather-driven.

</CalloutBox>

<DataTable
  caption="Tasks that usually carry float"
  headers={["Task", "Typical float", "Can happen", "Exception"]}
  rows={[
    ["Exterior Siding", "4-8 weeks", "While interior rough-ins and finishes happen", "In cold climates, must finish before weather turns"],
    ["Exterior Painting", "6-10 weeks", "Anytime after siding", "Temperature-dependent, so weather window matters"],
    ["Landscaping", "8-20 weeks", "Anytime after foundation, but typically last", "Final grading needed for final inspection"],
    ["Driveway Paving", "8-20 weeks", "Last item before occupancy", "May need temporary drive for access"],
    ["Gutters", "6-12 weeks", "After roof and siding complete", "Usually done just before final inspection"],
    ["Garage Doors", "4-8 weeks", "Anytime after framing", "Usually done after siding complete"]
  ]}
/>
...
<DataTable
  caption="Critical-path recovery options at a glance"
  headers={["Option", "Approach", "Cost", "When to use"]}
  rows={[
    ["A: Accelerate the delayed task", "Pay overtime/premium, add crew, work weekends, extend hours", "$500-3,000 depending on task", "Small delay (1-2 weeks), critical timing"],
    ["B: Accelerate downstream tasks", "Pre-order materials, add crews to future tasks, work parallel instead of sequential", "$1,000-5,000 depending on task", "Delay is locked in, but you can make up time later"],
    ["C: Change task sequencing", "Find work that can happen in parallel: exterior while waiting, flooring room-by-room, split crews", "Usually minimal", "When calendar delay but work available"],
    ["D: Accept the delay", "Unavoidable delay, or cost to accelerate exceeds cost of delay, or other tasks also delayed", "Carrying costs ($1,500-3,000 per week)", "When recovery cost exceeds delay cost"]
  ]}
/>
...
<DataTable
  caption="Foundation delay — recovery options compared"
  headers={["Option", "Effect", "Cost", "Net delay"]}
  rows={[
    ["1: Work weekends during framing", "Cuts 1 week from 6-week framing", "$3,000 premium", "1 week instead of 2"],
    ["2: Add second electrical crew during rough-in", "Cuts 1 week from 6-week rough-in", "$4,000 premium", "1 week instead of 2"],
    ["3: Accept 2-week delay", "No premium labor costs", "$3,000 in carrying costs", "2 weeks"]
  ]}
/>
...
<DataTable
  caption="Critical-path scheduling tools compared"
  headers={["Method", "Cost", "Good for"]}
  rows={[
    ["Spreadsheet", "Free", "Small projects (under 1,500 sq ft), simple designs"],
    ["Gantt Chart", "Free to $600+ (see tool options below)", "Most owner-builder projects"],
    ["Professional Scheduler", "$1,500-5,000 development, $500-1,000/month updates", "Complex custom homes, projects over $500,000, tight deadlines"],
    ["Simple Visual Timeline", "Pen and paper, whiteboard, sticky notes", "Very simple projects, visual learners, quick planning"]
  ]}
/>
...
<DataTable
  caption="Gantt chart tool options"
  headers={["Tool", "Cost"]}
  rows={[
...
<CalloutBox type="warning" title="The five mistakes that sink schedules">

Each mistake below comes from treating the schedule as a flat list instead of a critical path. The fixes are simple, but you have to apply them consistently.
...
<DataTable
  caption="Critical-path tasks worth crashing"
  headers={["Task", "Approach", "Cost to save 1 week", "Worth it if"]}
  rows={[
    ["Foundation", "Add crew, work overtime", "$1,500-3,000", "Tight deadline, good weather window"],
    ["Framing", "Add crew, work weekends", "$2,000-4,000", "Need to get dried in before weather"],
    ["Rough-ins", "Add second crew, work parallel", "$2,000-5,000", "Compressed schedule, hard deadline"],
    ["Drywall", "Add crew (but can't rush drying time)", "$1,000-2,000 to save a few days", "Minimal gain, usually not worth it"]
  ]}
/>
...
<CalloutBox type="success" title="What active management bought">

Final result: 4 weeks late instead of 7. Cost: $2,000 in crash costs vs. $10,000+ if the critical path hadn't been managed.

</CalloutBox>

## Key Takeaways

<CalloutBox type="tip" title="The seven rules of critical path">
