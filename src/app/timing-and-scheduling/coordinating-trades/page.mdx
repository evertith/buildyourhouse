export const metadata = {
  title: 'Coordinating Subcontractors - Trade Sequencing for Owner-Builders',
  description: 'Master subcontractor coordination and trade sequencing. Learn the proper order, timing, and management strategies to keep your build on schedule.',
};
