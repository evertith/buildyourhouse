export const metadata = {
  title: 'Material Lead Times for Home Building - When to Order Everything',
  description: 'Complete guide to material ordering timelines. Learn when to order windows, cabinets, trusses, and every material to avoid costly delays.',
};
