export const metadata = {
  alternates: { canonical: '/timing-and-scheduling/material-lead-times' },
...
<Checklist
  storageKey="material-lead-times-checklist"
  items={[
...
<Checklist
  storageKey="material-lead-times-checklist-2"
  items={[
...
<Checklist
  storageKey="material-lead-times-checklist-3"
  items={[
...
<Checklist
  storageKey="material-lead-times-checklist-4"
  items={[
    'Cabinets delivered',
...
<Checklist
  storageKey="material-lead-times-checklist-5"
  items={[
