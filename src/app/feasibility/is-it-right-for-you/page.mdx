export const metadata = {
  title: 'Is Owner-Building Right for You? - Self Assessment Guide',
  description: 'Take our comprehensive self-assessment to determine if building your own home is the right choice. Honest evaluation from a retired GC.',
};
