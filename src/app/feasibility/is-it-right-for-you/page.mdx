export const metadata = {
  alternates: { canonical: '/feasibility/is-it-right-for-you' },
...
You're ready to move — and the gap between a smooth build and a chaotic one is usually set in the first month. Once you commit, [your first 30 days as an owner-builder](/blog/first-30-days-as-owner-builder) lays out the systems to put in place right away.
...
Timing anxiety stalls a lot of would-be owner-builders. If what's really holding you back is whether the economy makes this the wrong year, read [is owner-building right during a recession?](/blog/is-owner-building-right-recession) before you decide.
