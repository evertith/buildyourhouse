export const metadata = {
  title: 'Owner-Builder Laws by State - Legal Requirements Guide',
  description: 'State-by-state guide to owner-builder requirements, restrictions, and regulations. Know your state\'s laws before you start building.',
};
