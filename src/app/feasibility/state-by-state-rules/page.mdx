export const metadata = {
  title: "Owner-Builder Laws by State (2026) — Permits, Licenses & Restrictions",
  description: "Know your state's owner-builder laws before you start. Covers all 50 states — permits, licensing, insurance, and sale restrictions. Updated for 2026.",
};
...
<EmailCapture source="state-rules" />
