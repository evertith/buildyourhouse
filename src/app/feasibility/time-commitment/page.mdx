export const metadata = {
  title: 'How Much Time Does Owner-Building Really Take? Honest Breakdown',
  description: 'Realistic weekly hours and total timeline for building your own home. Phase-by-phase time requirements from someone who has done it.',
};
