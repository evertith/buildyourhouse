export const metadata = {
  title: 'Owner-Builder Time Commitment - Realistic Timeline Expectations',
  description: 'Honest breakdown of time requirements for building your own home. Weekly hours, total timeline, and what to expect at each phase.',
};
