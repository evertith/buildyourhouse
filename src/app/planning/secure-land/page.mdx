...
<Checklist
  title="Create your must-have list"
  storageKey="secure-land-create-your-must-have-list"
  items={[
...
<Checklist
  ...
  storageKey="secure-land-check-zoning-and-restrictions"
  items={[
...
<Checklist
  ...
  storageKey="secure-land-visit-the-property"
  items={[
    'Walk the entire lot',
...
<Checklist
  ...
  storageKey="secure-land-research-utilities"
  items={[
...
For the full investigation list — 27 checks covering flood zones, wetlands, impact fees, and the hidden site costs that quietly turn a "$50K lot" into a "$90K ready-to-build" — work through [how to choose land for building](/blog/how-to-choose-land-for-building) before you write the offer.
...
<Checklist
  title="Offer should be contingent on"
  storageKey="secure-land-offer-should-be-contingent-on"
  items={[
...
<Checklist
  ...
  storageKey="secure-land-closing-process"
  items={[
...
**Solution:** Get setback requirements, measure available building envelope. The free [Site Plan Studio](/site-plan-studio) draws the parcel and its setback lines to scale, so you can see what's actually left to build on before you sign.
...
<Checklist
  title="Zoning and Legal"
  storageKey="secure-land-zoning-and-legal"
  items={[
...
<Checklist
  ...
  storageKey="secure-land-physical-conditions"
  items={[
...
<Checklist
  ...
  storageKey="secure-land-utilities-and-access"
  items={[
...
<Checklist
  title="Financial"
  storageKey="secure-land-financial"
  items={[
...
Ready to finance your project? See our [construction financing guide](/financing).
