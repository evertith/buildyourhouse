export const metadata = {
  title: 'How to Secure Land for Building Your House - Complete Guide',
  description: 'Learn how to find, evaluate, and purchase land for building your house. Zoning, utilities, soil testing, and financing for owner-builders.',
};
