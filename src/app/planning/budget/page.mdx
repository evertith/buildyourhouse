export const metadata = {
  title: 'Construction Budget Planning for Owner-Builders - Complete Guide',
  description: 'Create a detailed construction budget for your owner-builder project. Cost breakdowns, contingencies, tracking, and avoiding budget overruns.',
};
