export const metadata = {
  title: 'Construction Financing for Owner-Builders - Complete Guide',
  description: 'Learn how to finance your owner-builder project. Construction loans, requirements, approval process, and alternatives for building your own home.',
};
...
- Some rural development programs (USDA)
