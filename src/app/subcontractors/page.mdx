export const metadata = {
  title: 'Hiring Subcontractors - Complete Owner-Builder Guide to Finding & Managing Subs',
  description: 'Master subcontractor management for your owner-builder project. Learn how to find, vet, hire, and manage quality subs while avoiding costly mistakes.',
};
...
I've watched hundreds of owner-builders work with subcontractors. Here are the mistakes I see repeatedly:
...
**Need help building your subcontractor team?** Our [consulting services](/consulting) include sub recommendations, contract review, and on-site management support for owner-builders.
