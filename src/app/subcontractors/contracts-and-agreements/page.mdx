export const metadata = {
  alternates: { canonical: '/subcontractors/contracts-and-agreements' },
...
<ProductCTA
  ...
  title="A fifth option: the contract set, ready to fill in"
  lead="The Subcontractor Hiring Pack includes the subcontractor agreement, change order form, lien waivers, and payment draw schedule as print-ready PDFs and editable Word files — with the interview scorecard and reference check script for the vetting that comes first."
  price={29}
  sku="sub-hiring-pack"
  context="contracts-and-agreements"
  cta="See the pack"
/>
...
<Checklist
  storageKey="contracts-and-agreements-checklist"
  items={[
