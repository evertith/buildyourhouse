export const metadata = {
  title: 'Getting Accurate Subcontractor Quotes - How to Request and Compare Bids',
  description: 'Learn how to get accurate subcontractor quotes, compare bids intelligently, spot lowball estimates, and negotiate fair prices for your owner-builder project.',
};
...
**Real example**:
- Quote A: $15,000 for framing (includes labor only)
- Quote B: $18,000 for framing (includes labor + sheathing + house wrap)
- Quote C: $12,000 for framing (includes labor only, assumes owner provides all materials on-site)
...
Subcontractors price work in different ways:
...
The quality of quotes you receive depends on the quality of information you provide.
...
Timeline:
- Desired start: June 1, 2024
- Estimated duration: 7-10 days
- Must complete before: June 15, 2024
...
Plans: See attached foundation plan dated 4/15/2024
```
...
**Red flags in quotes**:
- Vague scope ("frame house")
- No payment terms specified
- No timeline provided
- "Materials TBD" or unclear specs
...
**Green flags**:
- Detailed scope broken down by task
- Clear payment schedule
- Specific timeline with milestones
- Named materials and specifications
- Professional format (letterhead, formatted)
- License and insurance info included
...
**Who provides materials matters**:

**Option 1: Contractor provides all materials**
- **Pros**: One-stop shopping, contractor manages ordering/delivery, warranty included
- **Cons**: Contractor markup (10-30%), less control over brands, may use cheaper options
- **When to use**: Full turnkey, busy schedule, trust contractor

**Option 2: Owner provides all materials**
- **Pros**: No markup, choose exact brands, potentially cheaper, can shop sales
- **Cons**: Timing risk, wrong quantities, storage issues, no contractor warranty on materials
- **When to use**: Want control, have time, know what you're doing

**Option 3: Hybrid (owner provides some, contractor provides others)**
- **Pros**: Control on key items, contractor manages difficult items
- **Cons**: Coordination complexity, potential delays, unclear responsibility
- **When to use**: Strategic approach to save money on big-ticket items
...
**As owner-builder**:
- You eliminate GC markup
- But pay retail for materials (no trade discount)
- Net savings: 15-25% typically
...
You received 3-5 quotes. Now compare them intelligently:
...
**Reality**: Legitimate quotes are valid for 30-60 days typically
...
**Remember**: These are estimates. Your costs will vary based on location, complexity, finishes, and market conditions.
...
**Don't**:
- "That's way too expensive" (insulting, no data)
- "I can get it cheaper on Craigslist" (then do that)
- "I'll pay cash if you lower the price" (asking for tax evasion)
- "My buddy says that should cost half" (your buddy isn't the professional)

**Do**:
- "I'd like to work with you, but I need to stay in budget. Can we find a solution?"
- "I have quotes ranging from X to Y. Here's what I'm looking for..."
- "What would bring the price down while maintaining quality?"
...
4. **Don't start work without contract**
   - Handshake + quote is not enough
...
**Remember**: The goal isn't the cheapest price. It's the best value for quality work that passes inspections and stays on schedule.

---

**Need help comparing subcontractor quotes?** Our [consulting services](/consulting) include quote review, scope verification, and contractor selection support for owner-builders.
