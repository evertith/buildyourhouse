...
<ProductCTA
  ...
  title="The printable version of this process"
  lead="The Subcontractor Hiring Pack turns everything above into paper you fill in: an interview scorecard so every bidder gets the same questions, a reference check script, the walk-away red-flag list, and the four contracts — agreement, change order, lien waivers, and draw schedule — with editable Word versions."
  price={29}
  sku="sub-hiring-pack"
  context="finding-quality-subs"
  cta="See the pack"
/>
...
<Checklist
  storageKey="finding-quality-subs-checklist"
  items={[
