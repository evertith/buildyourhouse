...
- Workers' comp is what protects you when the contractor's own worker is injured — general liability will not
...
17. **"What's your payment structure?"**
    ...
    - Deposit should be a 10-20% market norm at most — and your state may cap it much lower (see below)
    - Final payment after completion and inspection

18. **"Do you require a deposit, and how much?"**
    - 10-20% is a common market norm, but your state may cap it much lower
    - Several states legally cap residential deposits — California and Nevada at the lesser of 10% or $1,000, and Maryland/Massachusetts/Pennsylvania at one-third — and progress payments generally can't exceed the value of work performed. Check your state before agreeing to any deposit.
    - 30%+ is a red flag (and likely illegal in a capped state)
