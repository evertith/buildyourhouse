export const metadata = {
  title: 'The First 30 Days as an Owner-Builder: Critical Decisions & Systems to Set Up',
  description: 'What to do in your first month as an owner-builder. Critical early decisions, systems to implement, and lessons learned from successful builds.',
