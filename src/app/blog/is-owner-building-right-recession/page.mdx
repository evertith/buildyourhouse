export const metadata = {
  title: 'Is Owner-Building Right During a Recession? Economic vs. Life Timing',
  description: 'Should you build during economic uncertainty? Analyzing interest rates, material costs, labor availability, and why life timing sometimes trumps market timing.',
