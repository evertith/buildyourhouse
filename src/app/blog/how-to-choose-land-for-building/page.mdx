export const metadata = {
  title: 'How to Choose Land for Building: The Complete Due Diligence Checklist',
  description: 'What to look for before buying land for building. Due diligence checklist, hidden costs, red flags, and how to avoid a $50,000 mistake.',
...
- [ ] Soil evaluationfor septic system size
