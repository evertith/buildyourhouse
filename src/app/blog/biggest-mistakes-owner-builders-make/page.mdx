export const metadata = {
  title: 'The 10 Biggest Mistakes Owner-Builders Make (And How Much They Cost)',
  description: 'Learn from others mistakes. The top 10 owner-builder errors with real cost examples, why they happen, and exactly how to avoid them.',
