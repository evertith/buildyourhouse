export const metadata = {
  alternates: { canonical: '/move-in/moving-in' },
...
<Checklist
  ...
  storageKey="moving-in-essential-services"
  items={[
...
<Checklist
  ...
  storageKey="moving-in-homeowner-s-insurance"
  items={[
...
<Checklist
  title="Fire Safety"
  storageKey="moving-in-fire-safety"
  items={[
...
<Checklist
  title="Child Safety (if applicable)"
  storageKey="moving-in-child-safety-if-applicable"
  items={[
...
<Checklist
  title="Electrical"
  storageKey="moving-in-electrical"
  items={[
...
<Checklist
  title="Bathrooms"
  storageKey="moving-in-bathrooms"
  items={[
...
<Checklist
  title="Throughout House"
  storageKey="moving-in-throughout-house"
  items={[
    'Vacuum all carpets',
...
<Checklist
  ...
  storageKey="moving-in-final-preparation"
  items={[
...
<Checklist
  title="Moving supplies on-hand"
  storageKey="moving-in-moving-supplies-on-hand"
  items={[
    'Cleaning supplies',
    'Paper towels',
    'Trash bags',
...
<Checklist
  title="Protect your new house"
  storageKey="moving-in-protect-your-new-house"
  items={[
...
<Checklist
  title="First night priorities"
  storageKey="moving-in-first-night-priorities"
  items={[
    'Beds made',
    'Bathroom functional',
...
<Checklist
  ...
  storageKey="moving-in-week-1-priorities"
  items={[
...
<Checklist
  title="Document your new address"
  storageKey="moving-in-document-your-new-address"
  items={[
...
<Checklist
  ...
  storageKey="moving-in-meet-the-neighbors"
  items={[
    'Introduce yourself',
...
<Checklist
  storageKey="moving-in-checklist"
  items={[
...
<Checklist
  storageKey="moving-in-checklist-2"
  items={[
...
<Checklist
  ...
  storageKey="moving-in-create-lasting-memories"
  items={[
...
<Checklist
  ...
  storageKey="moving-in-utilities-and-services"
  items={[
...
<Checklist
  ...
  storageKey="moving-in-administration"
  items={[
