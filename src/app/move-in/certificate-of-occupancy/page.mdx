export const metadata = {
  title: 'Getting Your Certificate of Occupancy (CO) - Final Approval',
  description: 'Complete guide to obtaining your Certificate of Occupancy for owner-builders. Final inspection, requirements, and move-in approval.',
};
