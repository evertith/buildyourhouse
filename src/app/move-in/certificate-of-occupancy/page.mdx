...
<Checklist
  title="Be prepared"
  storageKey="certificate-of-occupancy-be-prepared"
  items={[
...
<Checklist
  title="Provide copy of CO to"
  storageKey="certificate-of-occupancy-provide-copy-of-co-to"
  items={[
...
<Checklist
  title="Safety Items"
  storageKey="certificate-of-occupancy-safety-items"
  items={[
...
<Checklist
  title="Completeness"
  storageKey="certificate-of-occupancy-completeness"
  items={[
...
<Checklist
  title="Site"
  storageKey="certificate-of-occupancy-site"
  items={[
