export const metadata = {
  title: 'Converting Your Construction Loan to Permanent Mortgage',
  description: 'Complete guide to converting your construction loan to a permanent mortgage. Process, requirements, timeline, and costs for owner-builders.',
};
